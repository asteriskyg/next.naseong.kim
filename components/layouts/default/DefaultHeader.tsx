...
const LiveBadge = dynamic(() =>
  import("@/components/layouts/default/LiveBadge").then((mod) => mod.LiveBadge)
);
...
export const DefaultHeader = async () => {
  ...
  return (
    <header className="z-10 flex justify-center h-14 border-b bg-slate-50/90 backdrop-blur-xl dark:border-neutral-600 dark:bg-twitch-dark/90">
